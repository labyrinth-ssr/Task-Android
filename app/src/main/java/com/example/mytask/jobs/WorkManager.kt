package com.example.mytask.jobs
...
//    fun scheduleRepeat(task: com.todoroo.astrid.data.Task)
//
...
//
//    companion object {
//        val REMOTE_CONFIG_INTERVAL_HOURS =12.toLong()
////        if (BuildConfig.DEBUG) 1 else
